...
if __name__ == "__main__":
    ...
    for file in os.listdir(folder_path):
        ...
        koalas_runner = LocalKoalasBenchmark()
        joblib_runner = LocalJoblibBenchmark()
        modin_runner = LocalModinBenchmark()
        spark_runner = LocalSparkBenchmark()
        dask_runner = LocalDaskBenchmark()
